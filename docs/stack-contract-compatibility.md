...
This matrix records the source contract baseline that RExecOp `0.2.22a0`
...
| `rexecop` | `0.2.22a0` | current package | Neutral runner, connectors, catalog and reaction mechanics. |
| `tecrax` | `0.3.11a0` | `tecrax==0.3.17a0` via optional extra | Domain infrastructure profile. |
