...
This matrix records the source contract baseline that RExecOp `0.2.13a0`
...
| `govengine` | `0.16.7` | `govengine==0.16.7` | PolicyEngine MVP, B2 enforcement-plan contracts, trigger-planning admission, supervisor-action admission and supervisor explanations. |
| `rexecop` | `0.2.13a0` | current package | Neutral runner, connectors, catalog and reaction mechanics. |
