...
This matrix records the source contract baseline that RExecOp `0.2.16a0`
...
| `rexecop` | `0.2.16a0` | current package | Neutral runner, connectors, catalog and reaction mechanics. |
