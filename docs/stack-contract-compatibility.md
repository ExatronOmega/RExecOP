...
This matrix records the source contract baseline that RExecOp `0.2.20a0`
...
| `rexecop` | `0.2.20a0` | current package | Neutral runner, connectors, catalog and reaction mechanics. |
| `tecrax` | `0.3.11a0` | `tecrax==0.3.14a0` via optional extra | Domain infrastructure profile. |
