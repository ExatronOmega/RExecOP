...
RExecOp `0.2.5a0` is **alpha** software, published on
[PyPI](https://pypi.org/project/rexecop/0.2.5a0/); maturity limits in
...
| Path | When to use |
| --- | --- |
| **PyPI** (`pip install rexecop==0.2.5a0`) | Quick evaluation when GovEngine/SCLite pins are acceptable |
...
python -m pip install "govengine>=0.15.0,<0.16" "sclite-core>=1.0.4,<1.1"
