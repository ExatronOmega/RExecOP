...
RExecOp **alpha** (`0.2.25a0` source candidate) — Regulated Execution Operations control-plane for
...
rexecop version   # expect 0.2.25a0 from the coordinated source checkout
