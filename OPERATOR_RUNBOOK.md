...
RExecOp **alpha** (`0.2.22a0` source line) — Regulated Execution Operations control-plane for
...
rexecop version   # expect 0.2.22a0 from the coordinated source checkout
