...
RExecOp **alpha** (`0.2.23a0` source line) — Regulated Execution Operations control-plane for
...
rexecop version   # expect 0.2.23a0 from the coordinated source checkout
