...
[![Package: rexecop 0.2.20a0](https://img.shields.io/badge/package-rexecop%200.2.20a0-blueviolet.svg)](https://pypi.org/project/rexecop/0.2.20a0/)
...
| Latest PyPI | [`rexecop==0.2.20a0`](https://pypi.org/project/rexecop/0.2.20a0/) |
...
```bash
python -m pip install "rexecop==0.2.20a0"
rexecop version
```

The published `0.2.20a0` wheel is the single supported alpha stack line for readonly
...
record path guarantees bundled in `0.2.20a0`.
...
```bash
pip install "rexecop[tecrax]==0.2.20a0"
