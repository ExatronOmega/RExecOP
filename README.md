...
[![Package: rexecop 0.2.13a0](https://img.shields.io/badge/package-rexecop%200.2.13a0-blueviolet.svg)](https://pypi.org/project/rexecop/0.2.13a0/)
...
| Latest PyPI | [`rexecop==0.2.13a0`](https://pypi.org/project/rexecop/0.2.13a0/) |
| Source dependencies | `govengine==0.16.7`, `sclite-core==1.0.8` (see `pyproject.toml`) |
...
```bash
python -m pip install "rexecop==0.2.13a0"
rexecop version
```

The published `0.2.13a0` wheel is the single supported alpha stack line for readonly
...
```bash
pip install "rexecop[tecrax]==0.2.13a0"
