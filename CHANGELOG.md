...
PyPI alpha line is **`0.2.21a0`**. Entries under
...
- Published `rexecop==0.2.21a0` on PyPI with `govengine==0.16.9`, `sclite-core==1.0.8`
  and `tecrax==0.3.15a0` extra pin; clean-install smoke green on repaired line.
